                                    ...
                                    ->schema([
                                        Section::make('Hero block global settings')
                                            ...
                                            ->schema([
                                                ...
                                                TailwindColorPicker::make('backgroundColor')
                                                    ->bgScope(),
                                                Select::make('fullwidth')
                                                    ->label('Full width ?')
                                                    ->hint("Does the hero's content takes all width or only the center part ?")
                                                    ->columnSpan(1)
                                                    ->nullable()
                                                    ->options([
                                                        'container mx-auto' => 'Center part',
                                                        'max-w-screen-7xl' => 'Full width'
                                                    ])
                                        ...
                                        Section::make('Main content')
                                            ...
                                            ->schema([
                                                Grid::make()
                                                    ->columns(3)
                                                    ->schema([
                                                        Fieldset::make('Hero title')
                                                            ->columns(3)
                                                            // ->columnSpan(3)
                                                            ->schema([
                                                                MarkdownEditor::make('heroTitle')
                                                                    ->label('Title')
                                                                    ->columns(2)
                                                                    ->columnSpan(2)
                                                                    ->required(),
                                                                Grid::make(1)
                                                                    ...
                                                                    ->schema([
                                                                        ...
                                                                        TailwindColorPicker::make('titleTextColor')
                                                                            ->columnSpan(1)
                                                                            ->textScope(),
                                                                        Select::make('heroTitleTextPosition')
                                                                            ->label('Position for title text')
                                                                            ->options([
                                                                                'text-left' => 'Left',
                                                                                'text-center' => 'Center',
                                                                                'text-right' => 'Right',
                                                        ...
                                                        Fieldset::make('Hero subtitle')
                                                            ...
                                                            ->schema([
                                                                ...
                                                                Grid::make(1)
                                                                    ...
                                                                    ->columnSpan(1)
                                                                    ->schema([
                                                                        Select::make('heroSubtitleTextSize')
                                                                        ->columnSpan(1)
                                                                        ->options([
                                                                            'text-7xl' => 'text-7xl',
                                                                            'text-6xl' => 'text-6xl',
                                                                        ...
                                                                        TailwindColorPicker::make('subtitleTextColor')
                                                                            ->columnSpan(1)
                                                                            ->textScope(),
                                                                        Select::make('heroSubtitleTextPosition')
                                                                            ->label('Position for the subtitle text')
                                                                            ->options([
                                                                                'text-left' => 'Left',
                                                                                'text-center' => 'Center',
                                                                                'text-right' => 'Right',
                                                ...
                                                Grid::make()
                                                    ->columns(3)
                                                    ->schema([
                                                        Fieldset::make('Hero description')
                                                            ->columns(3)
                                                            ->schema([
                                                                MarkdownEditor::make('heroDescription')
                                                                ...
                                                                Grid::make(1)
                                                                    ...
                                                                    ->columnSpan(1)
                                                                    ->schema([
                                                                        Select::make('heroDescriptionTextSize')
                                                                            ->columnSpan(1)
                                                                            ->options([
                                                                                'text-7xl' => 'text-7xl',
                                                                                'text-6xl' => 'text-6xl',
                                                                        ...
                                                                        TailwindColorPicker::make('descriptionTextColor')
                                                                            ->columnSpan(1)
                                                                            ->textScope(),
                                                                        Select::make('heroDescriptionTextPosition')
                                                                            ->label('Position for the description text')
                                                                            ->options([
                                                                                'text-left' => 'Left',
                                                                                'text-center' => 'Center',
                                                                                'text-right' => 'Right',
                                                ...
                                                Grid::make(2)
                                                    ->schema([
                                                        ...
                                                        Toggle::make('heroCtaUrlTarget')
                                                            ...
                                                            ->default(true)
                                                            ->columnSpan(1),
                                                        Select::make('heroCtaButtonPosition')
                                                            ->label('Position for the button')
                                                            ->options([
                                                                'items-start' => 'Left',
                                                                'items-center' => 'Center',
                                                                'items-end' => 'Right',
