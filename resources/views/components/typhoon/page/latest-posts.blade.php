{{-- <div class="col-span-12 container mx-auto flex px-5 py-16 md:flex-row flex-col items-center">
    <section>
...
<div class="col-span-12">
    <section class="text-grey-900 body-font">
        ...
        {{-- <div class="mx-auto md:pt-16 md:grid-rows-1 max-w-screen-2xl grid grid-cols-12"> --}}
