        ...
        <div class="container px-5 py-24 mx-auto flex flex-col">
            <div class="lg:w-4/6 mx-auto">
                <div class="rounded-lg h-full overflow-hidden">
                    <img alt="content" class="object-cover object-center h-full w-full lazyload" data-src="{{ Storage::url($post->main_image) }}">
                </div>
                    ...
                    <div class="sm:w-1/4 text-center sm:pr-8 sm:py-8">
                        <div
                            ...
                            @if($post->user->picture)
                                <img data-src="{{ Storage::url($post->user->picture) }}" alt="{{ $post->user->name }} picture" class="rounded-full lazyload">
                            @else
